...
export const allTitles = {
  ...
  'animated-tv-series': {
    ...
    '2025|Your Friendly Neighborhood Spider-Man': {
      ...
      wikipedia: 'https://en.wikipedia.org/wiki/Your_Friendly_Neighborhood_Spider-Man',
      numSeasons: 1,
      numEpisodes: 10,
      key: '2025|Your Friendly Neighborhood Spider-Man',
      label: [],
    },
    '2025|Iron Man and His Awesome Friends': {
      ...
      wikipedia: 'https://en.wikipedia.org/wiki/Iron_Man_and_His_Awesome_Friends',
      numSeasons: 1,
      numEpisodes: 10,
