...
export const map: Record<Key, Roster> = {
  ...
  '2016|Doctor Strange': {
    major: new Set(),
    minor: new Set(),
    major_: ['Doctor Strange', 'Baron Mordo', 'Wong', 'The Ancient One', 'Dormammu'],
    minor_: ['Thor'],
  },
  '2017|Logan': {
    major: new Set(),
  ...
  '2023|Spider-Man: Across the Spider-Verse': {
    ...
    minor_: ['Araña', 'Scarlet Spider', 'Symbiote Spider-Man', 'Spider-Man Noir'],
  },
  '2023|The Marvels': {
    major: new Set(),
    minor: new Set(),
  ...
  '2008–2009|The Spectacular Spider-Man': {
    ...
    minor_: ['Black Cat', 'Silver Sable', 'Uncle Ben', 'Hydro-Man'],
  },
  ...
  '2023|Moon Girl and Devil Dinosaur': {
    ...
    minor_: ['Maria Hill', 'Falcon', 'Nick Fury', 'Redwing', 'Quinjet'],
  },
  "2024|X-Men '97": {
    major: new Set(),
    minor: new Set(),
