...
export const map: Record<Title, Cast> = {
  ...
  '2022|Doctor Strange in the Multiverse of Madness': { full: ['Baron Mordo'], semi: [] },
  '2022|Thor: Love and Thunder': { full: [], semi: [] },
  '2022|Black Panther: Wakanda Forever': { full: [], semi: [] },
  '2023|Ant-Man and the Wasp: Quantumania': { full: [], semi: ['Stature'] },
  '2023|Guardians of the Galaxy Vol. 3': { full: ['Cosmo'], semi: ['Howard the Duck'] },
