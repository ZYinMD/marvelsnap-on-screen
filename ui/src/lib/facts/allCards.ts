...
export const allCards = {
  ...
  'Mirage': {
    ...
    name: 'Mirage',
    description:
      "<b>On Reveal:</b> Copy the card that costs the least from your opponent's hand into your hand. Give it +2 Power.",
  ...
  'Thanos': {
    ...
    name: 'Thanos',
    description:
      '<b>Game Start:</b> Draw Thanos and shuffle the six Infinity Stones\ninto your deck.',
    seriesStartTimestamps: [-62135596800000],
  },
  'Cassandra Nova': {
    defId: 'CassandraNova',
